...
format:
  revealjs:
    ...
    title-slide-attributes:
      data-background-image: "assets/dashboard/opening-slide.svg"
      data-background-color: "#72994D"
...
## Attendee Locations 2024-09-08 20:37 {.plot-slide}
...
## Favorite [Python]{style="color: #419599"} Packages
...
<!-- {{ < qrcode https://pos.it/funform colorDark="#297075" height=800 width=800 > }} -->

## {#closing background-image="assets/dashboard/closing-slide.svg" background-size="contain" background-color="#429599"}
